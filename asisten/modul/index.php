        ...
        <table class="min-w-full bg-white border border-gray-200">
            <thead class="bg-gray-100">
                <tr>
                    ...
                    <th class="px-4 py-2 text-left border-b">Praktikum</th>
                    <th class="px-4 py-2 text-left border-b">Judul</th>
                    <th class="px-4 py-2 text-left border-b">File Materi</th>
                    <th class="px-4 py-2 text-center border-b">Aksi</th>
                </tr>
            </thead>
            <tbody>
                <?php if ($result->num_rows > 0): ?>
                    <?php while ($modul = $result->fetch_assoc()): ?>
                        <tr class="hover:bg-gray-50">
                            <td class="px-4 py-2 border-b"><?= $modul['id_modul'] ?></td>
                            <td class="px-4 py-2 border-b"><?= htmlspecialchars($modul['Nama_praktikum']) ?></td>
                            <td class="px-4 py-2 border-b"><?= htmlspecialchars($modul['Judul']) ?></td>
                ...
                <?php else: ?>
                    <tr>
                        <td colspan="5" class="px-4 py-4 text-center text-gray-500">Belum ada modul yang ditambahkan.</td>
                    </tr>
                <?php endif; ?>
            </tbody>
        </table>
